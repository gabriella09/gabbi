...
public class RepositorioDados {
    ...
    */
    ...
    public static void inicializandoDados() {
        ...
        Produto p1 = new Produto("Produto 1" , "... ", 800.99, 500.00);
        Produto p2 = new Produto("Produto 2" , "... ", 2500.99, 1500.00);
        Produto p3 = new Produto("Produto 3" , "... ", 700.99, 200.00);
        ...
        */
        ...
        Cliente c1 = new Cliente("ClienteA", 123, 1215);
        Cliente c2 = new Cliente("ClienteB", 1234, 143215);
        Cliente c3 = new Cliente("ClienteC", 12345, 1223415);
...
//        posicaoLivre++;
 ...
 return funcionario;
   ...
   listaFuncionario.remove(funcionario);
    ...
    public static void excluirProdutos(Produto produtos){
