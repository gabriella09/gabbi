...
public class JNumberFormatField extends JTextField {
      private static final long serialVersionUID = -7506506392528621022L; 
        ...
        public JNumberFormatField(NumberFormat format) {// define formato do 
            // número 
            numberFormat = format;// alinhamento horizontal texto 
            setHorizontalAlignment(RIGHT);// doc responsável pela formatação 
            // do campo 
            setDocument(new PlainDocument() { 
                ...
                public void insertString(int offs, String str, AttributeSet a) throws BadLocationException { 
                    ...
                    super.insertString(0, numberFormat.format(new BigDecimal(getLimit() > 0 == text.length() > getLimit() ? text.substring(0, getLimit()) : text).divide(new BigDecimal(pow(10, numberFormat.getMaximumFractionDigits())))), a); 
                } 
        ...
        public final BigDecimal getValue() { 
            return new BigDecimal(getText().replaceAll("[^0-9]", "")).divide(new BigDecimal(pow(10, numberFormat.getMaximumFractionDigits()))); 
        } 
